...
[gtrendsR CRAN Package](https://cran.r-project.org/web/packages/gtrendsR/gtrendsR.pdf) used to perform and display Google Trends Queries.
...
In order to produce research that is both reproducible and timely, certain parameters can be initialized. Since gTrendsR can easily return Google Trends information from the past five years, it is 
...
A list of all FEMA declarations for hurricanes in Florida occuring in the last 5 years.
...
A list of all FEMA declarations for wildfires in California occuring in the last 5 years.
...
*2) Does interest in climate change increase regionally after the occurrence of a natural disaster?*


*3) Do people become more environmentally conscious, and modify their Google search behavior after a natural disaster?*
